 ...
 * @since 1/08/2016
 */
public class EmailSearchRanker {
    String _indexPath;
    ...
    public EmailSearchRanker(String index_path, String default_field, Analyzer a)
            throws IOException {
    ...
    public void doSearch(String query, int num_hits, PrintStream ps)
        ...
        File textFile = new File("src/search/retrieved.txt");
        try (FileOutputStream fop = new FileOutputStream(textFile,true)) {
            ...
            for (int i = 0; i < hits.length; i++) {
                ...
                String content = query.replaceAll("A-Za-z","") + " Q0 "+fileName+ " "+
    ...
    public static void main(String[] args) throws Exception {
        ...
        EmailSearchRanker r = new EmailSearchRanker(b._indexPath, default_field, b._analyzer);
        QueryTermReader queryTermReader = new QueryTermReader();
