...
public class SimpleSearchRanker {
	...
	public void doSearch(String query, int num_hits, PrintStream ps) 
		...
		for (int i = 0; i < hits.length; i++) {
		    ...
		    ps.println((i + 1) +" Q0 "+ ". (" + _df.format(hits[i].score)
		    		   + ") " + d.get("PATH"));
		}
		System.out.println();
	}
	...
	public static void main(String[] args) throws Exception {
		...
		r.doSearch("ducks", 14, System.out);
		r.doSearch("ig nobel prizes", 14, System.out);
		r.doSearch("mathematics", 14, System.out);
		r.doSearch("flowing hair", 14, System.out);
		r.doSearch("music", 14, System.out);
		r.doSearch("AIR TV", 14, System.out);
